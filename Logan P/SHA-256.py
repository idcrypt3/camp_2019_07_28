...
def SHA256(message: int):
    # SHA-256 process using preprocessed message
    # Initial hash values
...
# You can compare them at https://csrc.nist.gov/projects/cryptographic-standards-and-guidelines/example-values
m1 = ""
p1 = pad_message(m1)
h1 = SHA256(p1)
print(hex(p1))
